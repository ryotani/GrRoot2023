...
public:
  ...
  void Set(Short_t ch, vector<Int_t> data){
    fchan.push_back(ch);
    ftime.push_back(data);
  }
  Short_t GetNChan(){return fchan.size();}
  vector<Short_t>* GetChannels(){return &fchan;}
  Short_t GetChanMult(int ch){return ftime[ch].size();}
  vector<Int_t>* GetTimes(int ch){return &ftime[ch];}

protected:
  vector<Short_t> fchan;
  vector< vector<Int_t> > ftime;
...
public:
  ...
  GMesyTDC* GetMesyTDC(){return &fMTDC;}
