...
public:
  ...
  Float_t OBJ_Offset(){return fOBJ_Offset;}
  Float_t XFP_Offset(){return fXFP_Offset;}
  ...
  Float_t MOBJe1C(){return fm_objE1C;}
  Float_t MOBJC(){return fm_objC;}
  Float_t MXFPe1C(){return fm_xfpE1C;}
  Float_t MXFPC(){return fm_xfpC;}
  ...
  int GetMTDCRefChannel(){return fMTDCrefchan;}
  float GetMTDC_XFPGate_low(){return fMTDC_XFPgate[0];}
  float GetMTDC_XFPGate_high(){return fMTDC_XFPgate[1];}
  float GetMTDC_OBJGate_low(){return fMTDC_OBJgate[0];}
  float GetMTDC_OBJGate_high(){return fMTDC_OBJgate[1];}
  //histo ranges
  ...
  int GetRangeMOBJ(int i){return fmobj_range[i];}
  int GetRangeMXFP(int i){return fmxfp_range[i];}
  ...
  int GetRangeMOBJC(int i){return fmobjC_range[i];}
  int GetRangeMXFPC(int i){return fmxfpC_range[i];}
...
protected:
  ...
  int fMTDCrefchan;
  float fMTDC_XFPgate[2];
  float fMTDC_OBJgate[2];
