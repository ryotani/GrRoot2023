...
public:
  ...
  void Set(Short_t ch, vector<Int_t> data){
    switch(ch){
    case 0:
      fE1up = data;
      break;
    ...
    case 15:
      ...
      break;
    default:
      //cout << "unrecognized channel "<< ch<<" in MTDC" << endl;
      break;	
    }
  }
  vector<Int_t>* GetE1up(){return &fE1up;}
  vector<Int_t>* GetE1dw(){return &fE1dw;}
  vector<Int_t>* GetXFP(){return &fxfp;}
  vector<Int_t>* GetOBJ(){return &fobj;}
  vector<Int_t>* GetRF(){return &frf;}
  vector<Int_t>* GetCRDC0(){return &fcrdc0;}
  vector<Int_t>* GetCRDC1(){return &fcrdc1;}
  vector<Int_t>* GetHodo(){return &fhodo;}
  vector<Int_t>* GetE1ref(){return &fE1ref;}
...
public:
  ...
  void SetMOBJV(Float_t obj){
    fm_objv.push_back(obj);
  }
  void SetMOBJCorrV(Float_t obj, Float_t cor){
    fm_objcv.push_back(obj+cor);
  }
  void SetMOBJ(Float_t obj){
    fm_obj = obj;
  }
  void SetMOBJCorr(Float_t obj, Float_t cor){
    fm_objc = obj+cor;
  }
  void SetMXFPV(Float_t xfp){
    fm_xfpv.push_back(xfp);
  }
  void SetMXFPCorrV(Float_t xfp, Float_t cor){
    fm_xfpcv.push_back(xfp+cor);
  }
  void SetMXFP(Float_t xfp){
    fm_xfp = xfp;
  }
  void SetMXFPCorr(Float_t xfp, Float_t cor){
    fm_xfpc = xfp+cor;
  }
  ...
  vector<Float_t>* GetMOBJV(){return &fm_objv;}
  vector<Float_t>* GetMXFPV(){return &fm_xfpv;}
  Float_t GetMOBJ(){return fm_obj;}
  Float_t GetMXFP(){return fm_xfp;}
  //corr
  ...
  vector<Float_t>* GetMOBJCV(){return &fm_objcv;}
  vector<Float_t>* GetMXFPCV(){return &fm_xfpcv;}
  Float_t GetMOBJC(){return fm_objc;}
  Float_t GetMXFPC(){return fm_xfpc;}
...
protected:
  ...
  //! The obj timing, measured with the MTDC.
  vector<Float_t> fm_objv;
  Float_t fm_obj;
  //! The xfp timing, measured with the MTDC.
  vector<Float_t> fm_xfpv;
  Float_t fm_xfp;
  //! The obj timing, measured with the MTDC, corrected for angle and position.
  vector<Float_t> fm_objcv;
  Float_t fm_objc;
  //! The xfp timing, measured with the MTDC, corrected for angle and position.
  vector<Float_t> fm_xfpcv;
  Float_t fm_xfpc;
  ClassDef(TOF, 1);
};
...
public:
  ...
  Float_t GetPtotC(){return fptot;}
  Float_t GetPparC(){return fppar;}
  Float_t GetPtraC(){return fptra;}
  Float_t GetEtotC(){return fetot;}
  ...
  void SetDTAC(Float_t value){fdtac = value;}
  ...
  void SetPtotC(Float_t value){fptotc = value;}
  void SetPparC(Float_t value){fpparc = value;}
  void SetPtraC(Float_t value){fptrac = value;}
  void SetEtotC(Float_t value){fetotc = value;}
...
public:
  ...
  void SetHitPattern(unsigned int hitpattern){fhitpattern = hitpattern;}
  ...
  unsigned int GetHitPattern(){return fhitpattern;}
...
public:
  ...
  void SetMTDC(MTDC mtdc){fMTDC = mtdc;}
